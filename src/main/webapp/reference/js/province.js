            ...
            if(($(this).children("p").css("display"))=="none"){
                ...
                if(($(this).children("p").children("div").length)==""){
                    for(var j=0;j<dsy.Items[x].length;j++){
                        $(this).children("p").append("<div class='"+x+"_"+j+"'><span>"+dsy.Items[x][j]+"</span><p></p></div>");
                    }
                }
...
//台湾地区判断
                        if(y=="0_33_0"||y=="0_33_1"||y=="0_33_2"||y=="0_33_3"||y=="0_33_4"||y=="0_33_5"||y=="0_33_6"||y=="0_33_7"||y=="0_33_8"||y=="0_33_9"||y=="0_33_10"||y=="0_33_11"||y=="0_33_12"||y=="0_33_13"||y=="0_33_14"||y=="0_33_15"||y=="0_33_16"||y=="0_33_17"||y=="0_33_18"){
                            ...
                            if(($(this).children("p").children("span").length)==""){
                                for(var l=0;l<dsy.Items[y].length;l++){
                                    $(this).children("p").append("<span>"+dsy.Items[y][l]+"</span>");
                                }
                            }

                            $(".xiala>div>p>div>p>span").on("click",function(eee){
                                eee.stopPropagation();
                                qq=$(this).html();
                                var xhr=ss+si+qq;
                                $(".ku>span").html(xhr);
...
$(document).ready(function () {
    $(".obstaclecancel").on("click",function () {
        $(".obstacleInputs").val(" ");
        $(".obstacleInputs ").remove();
        $(".obstaclecancel").remove();
        $(".obstacleNames").remove();
    });
});
